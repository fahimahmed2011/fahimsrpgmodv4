package net.fahim.fahimsrpgmod.sound;
...
public class ModSounds {
    ...
    public static final  SoundEvent MAGIC_BLOCK_STEP = registerSoundEvent("magic_block_break");
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(FahimsRPGMod.MOD_ID, name);
